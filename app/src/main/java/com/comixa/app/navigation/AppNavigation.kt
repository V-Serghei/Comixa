...
import com.comixa.feature.library.RecentlyReadScreen
...
private const val ROUTE_RECENTLY_READ = "recently_read"
...
fun AppNavigation(
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            ModalDrawerSheet {
                ...
                NavigationDrawerItem(
                    ...
                    selected = currentRoute == ROUTE_RECENTLY_READ,
                    onClick = {
                        scope.launch { drawerState.close() }
                        navController.navigate(ROUTE_RECENTLY_READ) {
                            launchSingleTop = true
                        }
                    },
                    modifier = Modifier.padding(NavigationDrawerItemDefaults.ItemPadding),
        ...
        NavHost(
            ...
            composable(ROUTE_RECENTLY_READ) {
                RecentlyReadScreen(
                    onBookClick = { book -> navController.navigate("reader/${book.id}") },
                    openDrawer = openDrawer,
                )
